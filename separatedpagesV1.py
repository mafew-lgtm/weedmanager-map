...
<head>
    ...
    <style>
        ...
        * {{ box-sizing: border-box; }}
        ...
        .pub-legend-row {{ display: flex; align-items: center; font-size: 12px; margin-bottom: 4px; }}
        .pub-badge {{ width: 11px; height: 11px; border-radius: 50%; margin-right: 7px; flex-shrink: 0; }}
        .pub-stats {{ margin-top: 10px; padding-top: 10px; border-top: 1px solid #eee; font-size: 11px; color: #777; }}
